...
def benchmark():
    ...
    ns = dict(matrix=matrix, mat1=mat1, mat2=mat2, tsize=tsize)
    t_naive = timeit.Timer('matrix.multiply_naive(mat1, mat2)', globals=ns)
    t_tile = timeit.Timer("matrix.multiply_tile(mat1, mat2, tsize)", globals=ns)
    t_mkl = timeit.Timer("matrix.multiply_mkl(mat1, mat2)", globals=ns)
