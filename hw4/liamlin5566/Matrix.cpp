...
// Matrix::Matrix(Matrix const & other): m_nrow(other.m_nrow), m_ncol(other.m_ncol), m_buffer(other.m_buffer)
// {
//     //reset_buffer(other.m_nrow, other.m_ncol);
//     //m_buffer = std::vector<double, CustomAllocator<double>>(m_nrow * m_ncol, 0.0); 
