...
Line::Line(Line const& other) : x_coords(other.x_coords), y_coords(other.y_coords) {}

Line::Line(Line&& other) : x_coords(std::move(other.x_coords)), y_coords(std::move(other.y_coords)) {}
